    ...
    <section style={{
      ...
      <div style={{
        ...
        >
          ...
          <ChevronRight style={{ width: 12, height: 12 }} />
          <span style={{ color: "rgba(165,180,252,0.9)", fontWeight: 600 }}>Design Verification</span>
        </motion.div>
        ...
        >
          Layered verification flows combining UVM methodology, SystemVerilog assertions,
          formal property checking and emulation — built to eliminate functional risk
          and achieve silicon sign-off confidence.
        </motion.p>
        ...
        >
          <MagButton primary href="/contact">
            Start Verification Project <ArrowRight style={{ width: 16, height: 16 }} />
          </MagButton>
      ...
      {/* ── SCROLL INDICATOR — z-index 3, above stat strip ── */}
      <motion.div
        animate={{ y: [0, 8, 0] }}
      ...
      {/* ── BOTTOM STAT STRIP — z-index 3, pinned to bottom ── */}
      <motion.div
