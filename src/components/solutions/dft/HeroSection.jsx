    ...
    >
      ...
      <div style={{
        ...
        >
          ...
          <ChevronRight style={{ width: 12, height: 12 }} />
          <span style={{ color: "rgba(165,180,252,0.9)", fontWeight: 600 }}>DFT Expertise</span>
        </motion.div>
        ...
        >
          ...
          to ATPG pattern generation and post-silicon validation — ensuring maximum fault coverage
        ...
        >
          <MagButton primary href="/contact">
            Start DFT Project <ArrowRight style={{ width: 16, height: 16 }} />
          </MagButton>
