// HeroSection.jsx — Analog IP Hero
// AurowinX Analog IP
// Fully responsive — matches DV/DFT/PD hero pattern exactly
...
const pills = [
  ...
  "SERDES IP",
  "Clock & Power IP",
  "Sub-GHz Transceiver IP",
  "LDO / BGR",
  "PLL / DLL",
];

const STATS = [
  { value: "4+",    label: "Analog IP Blocks" },
  { value: "16nm+", label: "Advanced Nodes"   },
  { value: "100%",  label: "Silicon Proven"   },
  { value: "50+",   label: "IPs Delivered"    },
];
    ...
    >
      ...
      <div style={{
        ...
        >
          ...
          <ChevronRight style={{ width: 12, height: 12 }} />
          <span style={{ color: "rgba(165,180,252,0.9)", fontWeight: 600 }}>Analog IP</span>
        </motion.div>
        ...
        >
          Full-spectrum analog IP design and delivery — from high-speed SERDES
          and precision ADCs to clock generation and sub-GHz transceivers —
          tape-out ready across leading foundry nodes.
        </motion.p>
        ...
        >
          ...
          <span className="sol-hero-trust-line">Trusted by Tier-1 analog IP customers worldwide</span>
          <span className="sol-hero-trust-full">TSMC · Samsung · GlobalFoundries · UMC — down to 16nm</span>
        </motion.p>
      </div>
