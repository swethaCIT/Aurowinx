...
const products = [
  {
    ...
    description: 'Product architecture, hardware design, PCB, simulation, EMI/EMC, thermal, and compliance.',
    color: 'text-sky-400',
    bg: 'bg-sky-500/10',
    accent: '#38bdf8',
    glowA: 'rgba(56,189,248,0.45)',
    glowB: 'rgba(14,165,233,0.25)',
    tag: 'Architecture / PCB / Compliance',
    headline: 'Concept to.',
    sub: 'Production.',
  ...
  },
  {
    ...
    description: 'EV charging, BLDC motor control, and solar inverters.',
    ...
    body: 'End-to-end development of power electronic products — BLDC fan controllers, EV chargers, and solar inverters.',
  },
  {
    icon: FlaskConical,
    name: 'R&D',
    path: '/products#rnd',
    description: 'Technology consulting, feasibility studies, proof-of-concept, and rapid prototyping.',
    color: 'text-violet-400',
    bg: 'bg-violet-500/10',
    accent: '#a78bfa',
    glowA: 'rgba(167,139,250,0.45)',
    glowB: 'rgba(124,58,237,0.25)',
    tag: 'Consulting / PoC / Prototyping',
    headline: 'Explore First.',
    sub: 'Scale Fast.',
    body: 'Technology consulting, feasibility studies, proof-of-concept development, rapid prototyping, testing, and engineering innovation.',
  },
];
