// components/career/Hero.jsx
// Same architecture as DV HeroSection — video bg, dark overlay, dot grid,
// magnetic buttons, bottom stat strip — Career-specific content only.
...
/* ─── Magnetic Button (identical to DV hero) ─────────────────────────────── */
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        cursor: "pointer", letterSpacing: "-0.01em", border: "none",
        ...(primary
          ? {
...
/* ─── Domain Pills ────────────────────────────────────────────────────────── */
const PILLS = [
  { label: "DFT Engineering",        icon: Cpu },
  { label: "RTL Verification",       icon: CircuitBoard },
  { label: "Physical Design",        icon: Layers },
  { label: "MBIST & Scan",           icon: FlaskConical },
  { label: "SoC Integration",        icon: Zap },
];
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        inset: 0, zIndex: 1,
        background:
          "linear-gradient(160deg, rgba(8,4,24,0.82) 0%, rgba(12,8,36,0.75) 50%, rgba(4,8,24,0.84) 100%)",
      }} />
      ...
      <div style={{
        ...
        >
          ...
          <span style={{ color: "rgba(165,180,252,0.9)", fontWeight: 600 }}>Careers</span>
        </motion.div>
        ...
        >
          Join a team of engineers shaping next-generation silicon through
          verification, DFT, and physical design. Real projects, real impact —
          from tape-out to production.
        </motion.p>
        ...
        >
          {PILLS.map((p, i) => (
            ...
            >
              <p.icon style={{ width: 11, height: 11, color: "#818cf8" }} />
              {p.label}
            </motion.span>
          ))}
        </motion.div>
        ...
        >
          <MagButton primary onClick={() => scrollTo("open-roles")}>
            View Open Roles <ArrowRight style={{ width: 16, height: 16 }} />
          </MagButton>
          <MagButton onClick={() => scrollTo("life-at-aurowinx")}>
            Life at AurowinX
          </MagButton>
        </motion.div>
        ...
        >
          ...
          Worked on projects for Qualcomm · TI · MediaTek · NXP · Marvell · ISRO
        </motion.p>
      </div>
      ...
      {/* ── BOTTOM STAT STRIP — z 3, pinned to bottom ─────────────────── */}
      <motion.div
